...
function validation()
 {
	...
	{
		document.getElementById("display").innerHTML="Please select your current semester";
	}
	else if(regn.value=="")
	{
		document.getElementById("display").innerHTML="Please enter your registration number";
	}
